...
case class Lot(LotId: Option[Int], name:String, address: String, Image: Option[String], rent: BigDecimal, capacity: Int)

class LotModel(tag: Tag) extends Table[Lot](tag, "lots"){
  def LotId = column[Int]("lot_id", O.PrimaryKey, O.AutoInc)
